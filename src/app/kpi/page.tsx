...
import {
  Calculator, Target, Clock, Zap, BarChart3, Loader2,
...
function KPIPanel({ stats, selectedMonth }: { stats: ReturnType<typeof computeKPIs>; selectedMonth: string }) {
  ...
  return (
    <div className="space-y-8">
      ...
      {/* Efficiency Chart + Outlier Cards */}
      <div className="grid gap-6 lg:grid-cols-2">
        <Card>
          <CardHeader>
            <CardTitle className="flex items-center gap-2"><BarChart3 className="h-5 w-5 text-primary" /> Efficiency Breakdown</CardTitle>
          </CardHeader>
      ...
      <Card className="border-none shadow-md overflow-hidden bg-card">
        <CardHeader className="bg-destructive/5 border-b border-destructive/10">
          ...
          <CardDescription>Closed tickets missing RT, SH, FCR, or Closer.</CardDescription>
        </CardHeader>
                ...
                <TableRow key={ticket.id} className="hover:bg-muted/20">
                  ...
                  <TableCell>
                    <div className="flex flex-wrap gap-1">
                      ...
                      {(!ticket.closedBy || ticket.closedBy === "") && <Badge variant="outline" className="text-[8px] h-4 bg-gray-50 text-gray-600 border-gray-100">Closer Missing</Badge>}
                    </div>
                  </TableCell>
